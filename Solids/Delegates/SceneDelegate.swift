...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func prepareRootViewController() -> UIViewController{
        guard let mainViewController = MainViewController.instantiate() as? MainViewController else { return UIViewController() }
        mainViewController.viewModel = ListViewModel()
